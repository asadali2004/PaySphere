...
/// <summary>
/// Validates LoginRequest DTOs and throws <see cref="PaySphere.BuildingBlocks.Exceptions.BaseException"/>
/// for invalid payloads. Keeps simple validation logic separate from services.
/// </summary>
